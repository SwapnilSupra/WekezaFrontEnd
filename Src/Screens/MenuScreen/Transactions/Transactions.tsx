...
import { WatchLSearchStyles } from '../../WatchlistScreens/WatchListSearch/WatchListSearchStyle';
...
const Transactions = ({ navigation }: any) => {
  ...
  const sendDetails = (data: any) => {
    // console.log('ppppp',data)
    AsyncStorage.setItem('savedocid', data);
    navigation.navigate('TransactionDetails');
  }
  useEffect(() => {
    // var initdt: any = date.getFullYear() + '-' + (date.getMonth() + 1).toString().padStart(2, "0") + '-' + date.getDate().toString().padStart(2, "0")
    // var initdtend: any = enddate.getFullYear() + '-' + (enddate.getMonth() + 1).toString().padStart(2, "0") + '-' + enddate.getDate().toString().padStart(2, "0")
    // setDate(initdt);
    // setendDate(initdtend)
  ...
  return (
    ...
    <View style={CommonStyles.ContainerPink}>
      ...
      <View style={[CommonStyles.sideSpace, CommonStyles.commonTopSP]}>
        <View style={CommonStyles.detailsScroll}>
          <View style={CommonStyles.detailsScrollTop}>
          ...
          <View>
            ...
            <TouchableOpacity>
              <View style={CommonStyles.downloadTop}>
                <Text style={CommonStyles.downloadTopLine}>{datasearch}</Text>
          ...
          <View>
            <ScrollView>
              {datasearch.map((key: any, index: any) => (
                <>
                  <View style={WatchListStyles.notificationBox}>
                    <Text style={WatchListStyles.notiText} onPress={() => sendDetails(key.id)}>
                      {key.date}
                    </Text>
                    {/* <Text style={WatchListStyles.hideText} >
                        {key.id} 
                        </Text> */}
                  </View>
                </>
                                  ...
                                  <View style={CommonStyles.cardHead}>
                                      <View style={CommonStyles.stLeft}>
                                          <View style={CommonStyles.stNamOut}>
                                              <Text style={CommonStyles.StockCode}>{item.type}</Text>
                                          </View>
                                      </View>
                                      <View style={CommonStyles.bellOut}>
                                          <TouchableOpacity
                                              onPress={() => downloadfun(item)}>
                                              <Text style={CommonStyles.tradeBut}>Download</Text>
                                          </TouchableOpacity>
                                      </View>
                                  </View>
                              </View>
      ...
      {/* <ScrollView>
              ...
              <View style={[SummaryStyles.editViewDNHead]}>
                <Text style={SummaryStyles.mainTxtDNHead}>Deposits and withdrawals Details</Text>
                <TouchableOpacity>
                </TouchableOpacity>
              </View>
            ...
            {(holdingsdata!==[] && viewflag== true) ?
              <View style={SummaryStyles.paper}>
              <View style={[SummaryStyles.editViewDNHead]}>
                <Text style={SummaryStyles.mainTxtDNHead}>Holdings</Text>
                <TouchableOpacity>
                </TouchableOpacity>
              </View>
            ...
            {(transactionsdata!==[] && viewflag== true) ?
              <View style={SummaryStyles.paper}>
              <View style={[SummaryStyles.editViewDNHead]}>
                <Text style={SummaryStyles.mainTxtDNHead}>transactions</Text>
                <TouchableOpacity>
                </TouchableOpacity>
              </View>
